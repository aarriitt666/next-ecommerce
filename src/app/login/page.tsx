    ...
    <form className="flex flex-col gap-8">
      ...
      ) : null}
      {
        mode !== MODE.EMAIL_VERIFICATION ? (
          ...
          <input type="email" name="email" placeholder="john@example.com" className="ring-2 ring-gray-300 rounded-md p-4"/>          
        </div>
        ) :
        (
          <div className="flex flex-col gap-2">
      ...
      <button className="bg-haodepink text-white p-2 rounded-md disabled:bg-pink-200 disabled:cursor-not-allowed" disabled={isLoading}>{isLoading ? "Loading..." : buttonTitle}</button>
