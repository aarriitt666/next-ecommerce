        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex justify-between'>
                <div className='flex items-center gap-4'>
                    ...
                    {stockNumber < 1 ? (<div className="text-xs">Product is out of stock</div>) : (<div className='text-xs'>Only <span className="text-orange-500">{stockNumber} items</span> left! <br /> {"Don't"} missed it.</div>)}
                </div>
